        ...
        <div className="p-2">
          <a href="tel:+3607687795">
            <div className="inline-flex items-center bg-white leading-none rounded-full p-2 shadow text-teal text-sm">
              <span className="inline-flex bg-yellow-500 text-white rounded-full h-12 px-3 justify-center items-center">
                <FontAwesomeIcon icon={faPhone} className="h-6 w-6" />
              </span>
              <span className="inline-flex px-2 text-4xl font-mono tracking-wide">
                Call for a Quote
              </span>
            </div>
          </a>
